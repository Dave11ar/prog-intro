...
public abstract class BinaryExpression implements Binary {
    ...
    public BinaryExpression(FullExpression first, FullExpression second, String operation, int priority, boolean important, boolean need) {
        this.first = first;
        this.second = second;
...
//        } else {
//            first.toMiniString(into);
//            into.append(" ").append(operation).append(" ");
//            second.toMiniString(into);
//        }
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(first, second, operation, priority, important, need);
    }
}
